...
function timeSpanToString(startDate, endDate) {
  ...
  const hour = res.getUTCHours() > 9 ? `${res.getUTCHours()}` : `0${res.getUTCHours()}`;
  const minute = res.getMinutes() > 9 ? `${res.getMinutes()}` : `0${res.getMinutes()}`;
  const seconds = res.getSeconds() > 9 ? `${res.getSeconds()}` : `0${res.getSeconds()}`;
  let milliseconds = res.getMilliseconds();
  if (milliseconds < 10) {
...
function angleBetweenClockHands(date) {
  ...
  const hour = time.getUTCHours() > 12 ? time.getUTCHours() - 12 : time.getUTCHours();
